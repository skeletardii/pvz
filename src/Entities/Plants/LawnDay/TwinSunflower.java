...
public class TwinSunflower extends Sunflower implements Upgraded {
    ...
    public TwinSunflower(int row, int col) {
        super(new PlantBuilder().setRow(row).setCol(col).setHealth(150).setSunCost(150).setPacketCooldown(SeedPacketRechargeTime.SLOW.getValue()).setSprite(sprite).setSpriteWidth(140).setSpriteHeight(140));
        animStart[0] = 8;
        animEnd[0] = 33;
        setFrame(4);
    }
